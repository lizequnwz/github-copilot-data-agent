...
only for audit, debugging, or automation that cannot use the guided workspace or
`--review-decisions`.

Replay it with:

```bash
uv run data-agent model setup SOURCE --review-patch workspaces/models/MODEL.review.patch.json
```
